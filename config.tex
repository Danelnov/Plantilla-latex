...
\newtcbtheorem{Teorema}{\large Teorema}
{%
    enhanced,
    breakable,
    colback = mytheorembg,
...
%================================
\tcbuselibrary{theorems,skins,hooks}
\newtcbtheorem{Corolario}{\large Corolario}
{%
    enhanced
    ,breakable
    ,colback = myp!10
...
\tcbuselibrary{theorems,skins,hooks}
\newtcbtheorem{Prepo}{\large Preposición}
{%
    enhanced,
    breakable,
    colback = mypropbg,
...
\tcbuselibrary{theorems,skins,hooks}
\newtcbtheorem{defi}{\large Definición}
{%
    enhanced
    ,breakable
    ,colback = primary!10
